...
if [ "$gtk" = "1" ] ; then
    g++ -o papaya  ../../src/linux_papaya.cpp -ldl -lGL -lX11 -lXi -O0 -g `pkg-config --cflags --libs gtk+-2.0` -DUSE_GTK && ./papaya
else
    g++ -o papaya  ../../src/linux_papaya.cpp -ldl -lGL -lX11 -lXi -O0 -g && valgrind ./papaya
fi
