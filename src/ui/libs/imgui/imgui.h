...
namespace ImGui
{
    ...
    IMGUI_API void          Render(void* mem);                          // ends the ImGui frame, finalize rendering data, then call your io.RenderDrawListsFn() function if set.
...
struct ImGuiIO
{
    ...
    void        (*RenderDrawListsFn)(ImDrawData* data, void* mem);
